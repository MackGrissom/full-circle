...
export default function Hero() {
  return (
    <section className="relative flex min-h-screen flex-col items-center justify-center px-8 md:px-12 lg:px-16">
      {/* Subtitle */}
      <motion.p
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1, delay: 0.2 }}
        className="mb-8 text-[13px] tracking-[0.3em] text-[#666] uppercase"
      >
        Software Agency
      </motion.p>

      {/* Main heading — Porto style: massive, uppercase, tight leading */}
      <motion.h1
      ...
      <motion.p
        ...
        className="mt-10 max-w-md text-center text-[15px] leading-[1.7] text-[#666]"
      >
